...
<body>
     ...
     if (file_exists("$archivo")) {
         ...
         //tratamos de abrirlo
         $x = fopen($archivo, 'r') or die("Error: No se puede abrir el archivo json");
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        for ($i = 0; $i < $numContactos; $i++) {
                            echo '<tr>';
                            // Como dijimos antes cada contacto es un arreglo asociativo
                            // por lo tanto tenemos una matriz o un arreglo de arreglos
