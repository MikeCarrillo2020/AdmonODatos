...
class miXML 
{
    ...
    public function insertPelicula(int $id, string $titulo, int $año, string $genero, string $clasificacion)
    {
        ...
        //creamos los nodos-campos al registro pelicula
    ...
    public function existenValores(): int
    {
        ...
        //si no se pudo cargar entonces mandamos -1
        if ($x === false) return -1;
...
//creamos método para leer datos de las películas
public function obtenerPeliculas()
{
    //cargamos el archivo XML
    $datos = simplexml_load_file($this->xml_nombre_archivo) or die("Error: No se puede generar el objeto SimpleXMLElement");
