...
<body>
    ...
    if (file_exists("$archivo")) {
        ...
        $ListaPel = json_decode($contenido, true);
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        for ($i = 0; $i < $NumeroPel; $i++) {
                            ...
                            echo '<td>' . $ListaPel[$i]['nombre'] . '</td>';
                            echo '<td>' . $ListaPel[$i]['genero'] . '</td>';
                            echo '<td>' . $ListaPel[$i]['duracion'] . '</td>';
                            echo '<td>' . $ListaPel[$i]['clasificacion'] . '</td>';
                            echo '<td>' . $ListaPel[$i]['protagonista'] . '</td>';
                            echo '</tr>';
                        } //fin for
                        ?> <!-- fin del script -->
                    </tbody>
